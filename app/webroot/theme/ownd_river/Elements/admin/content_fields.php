...
$fullUrl = $this->BcContents->getCurrentFolderLinkedUrl() . $contentsName;
$disableEdit = false;
...
<div class="bca-section bca-section__post-top">
  <span class="bca-post__url">
	  <a href="<?php echo $fullUrl ?>" class="bca-text-url" target="_blank" data-toggle="tooltip"
		 data-placement="top" title="<?php echo __d('baser', '公開URLを開きます') ?>"><i class="bca-icon--globe"></i><?php echo $fullUrl ?></a>
