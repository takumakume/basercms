...
<div class="section bca-main__section">
	...
	<?php $this->BcBaser->link(__d('baser', 'サーバーキャッシュを削除する'), array('controller' => 'site_configs', 'action' => 'del_cache'), array('class' => 'submit-token button-small bca-btn', 'confirm' => "サーバーキャッシュを削除します。いいですか？")) ?>　
</div>
...
<div class="section bca-main__section">
	...
	<?php $this->BcBaser->link(__d('baser', '固定ページテンプレート書出'), array('controller' => 'pages', 'action' => 'write_page_files'), array('class' => 'submit-token button-small bca-btn', 'confirm' => "データベース内のページデータを、ページテンプレートとして /app/View/Pages 内に全て書出します。本当によろしいですか？")) ?>　
	<?php $this->BcBaser->link(__d('baser', '固定ページテンプレート読込'), array('controller' => 'pages', 'action' => 'entry_page_files'), array('class' => 'submit-token button-small bca-btn', 'confirm' => "/app/View/Pages フォルダ内のページテンプレートを全て読み込みます。本当によろしいですか？")) ?>　
</div>
<div class="section bca-main__section">
