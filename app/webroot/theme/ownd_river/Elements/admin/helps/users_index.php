...
<p>システム管理グループのユーザーでログインしている場合、一覧の<?php $this->BcBaser->img('admin/icn_tool_login.png', array('alt' => __d('baser', 'ログイン'), 'title' => __d('baser', 'ログイン'))) ?>より簡単に他のユーザーとして再ログインする事ができます（代理ログイン）。<br />
