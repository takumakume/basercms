...
<ul>
	<li><?php echo sprintf(__d('baser', 'アクセス制限をかけるには各ユーザーグループの操作欄にある %s ボタンをクリックしておこないます。'), '<a href="#" class="bca-btn" data-bca-btn-type="permission" data-bca-btn-size="xs">権限ボタン</a>')?></li>
