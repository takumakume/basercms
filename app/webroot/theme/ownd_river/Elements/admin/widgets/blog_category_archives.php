...
<?php echo $this->BcForm->input($key . '.by_year', array('type' => 'checkbox', 'label' => __d('baser', '年別に表示する'))) ?><br />
<p id="Span<?php echo $key ?>Depth"><?php echo $this->BcForm->label($key . '.depth', __d('baser', '深さ')) ?>&nbsp;
	<?php echo $this->BcForm->input($key . '.depth', array('type' => 'text', 'size' => 6, 'default' => 1)) ?>&nbsp;<?php echo __d('baser', '階層') ?></p>
