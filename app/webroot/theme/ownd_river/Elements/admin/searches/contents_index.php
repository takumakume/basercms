...
<p class="bca-search__input-list">
	<span class="bca-search__input-item">
		...
		<?php echo $this->BcForm->input('Content.folder_id', ['type' => 'select', 'class' => 'bca-select', 'options' => $folders, 'empty' => __d('baser', '指定なし'), 'escape' => false]) ?>
	</span>
	<span class="bca-search__input-item">
	...
	<span class="bca-search__input-item">
		...
		<?php echo $this->BcForm->input('Content.type', ['type' => 'select', 'class' => 'bca-select', 'options' => $contentTypes, 'empty' => __d('baser', '指定なし')]) ?>
	</span>
	<span class="bca-search__input-item">
		<?php echo $this->BcForm->label('Content.self_status', __d('baser', '公開状態')) ?>
		<?php echo $this->BcForm->input('Content.self_status', ['type' => 'select', 'class' => 'bca-select', 'options' => $this->BcText->booleanMarkList(), 'empty' => __d('baser', '指定なし')]) ?>
	</span>
	<span class="bca-search__input-item">
		<?php echo $this->BcForm->label('Content.author_id', __d('baser', '作成者')) ?>
		<?php echo $this->BcForm->input('Content.author_id', ['type' => 'select', 'class' => 'bca-select', 'options' => $authors, 'empty' => __d('baser', '指定なし')]) ?>
	</span>
</p>
