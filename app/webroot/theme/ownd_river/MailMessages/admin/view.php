...
<!-- button -->
<p class="submit">
<?php $this->BcBaser->link('削除', array('action' => 'delete', $mailContent['MailContent']['id'], $message['MailMessage']['id']), array('class' => 'submit-token btn-gray button bca-btn', 'data-bca-btn-type' => 'delete'), sprintf('受信メール NO「%s」を削除してもいいですか？', $message['MailMessage']['id']), false); ?>
</p>
