	...
	<div id="ContentsMenu" class="bca-content-menu">
		<ul>
			<li class="bca-content-menu__item">
				...
				<?php $this->BcBaser->link(__d('baser', 'お気に入りに追加'), 'javascript:void(0)', array('id' => 'BtnFavoriteAdd', 'data-bca-fn' => 'BtnFavoriteAdd', 'class'=>'bca-content-menu__link bca-icon--plus-square')) ?></li>
			<?php if (!empty($help)): ?>
				<li class="bca-content-menu__item">
					<?php # TODO: button要素に変更 ?>
