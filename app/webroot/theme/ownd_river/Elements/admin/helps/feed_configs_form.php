...
<p><?php echo __d('baser', 'フィード設定の基本項目を入力します。<br>フィードごとにデザインを変更する場合には、画面下の「オプション」をクリックしてテンプレート名を変更します。<br><small>※ テンプレート名を変更した場合は、新しい名称のテンプレートを作成しアップロードする必要があります。</small><br> <br /><a href="https://basercms.net/manuals/designers/7.html" target="_blank"><i class="bca-icon--globe"></i>フィード読み込み部分のテンプレートを変更する</a>')?></p>
<ul>
