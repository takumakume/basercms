...
<tr>
	...
	<td class="bca-form-table__input"><?php $this->BcBaser->link($data['UserGroup']['name'], ['action' => 'edit', $data['UserGroup']['id']], ['escape' => true]) ?>
		<?php if ($data['User']): ?><br>
	...
	<td class="bca-form-table__input"><?php echo h($data['UserGroup']['title']) ?></td>
