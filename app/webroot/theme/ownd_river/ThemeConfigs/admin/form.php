...
<table class="form-table bca-form-table">
	<tr>
		...
		<td class="bca-form-table__input">
			<small>[メイン]</small> #<?php echo $this->BcForm->input('color_main', array('type' => 'text', 'size' => 6, 'class' => 'color-picker bca-input-color')) ?>　
			<small>[サブ]</small> #<?php echo $this->BcForm->input('color_sub', array('type' => 'text', 'size' => 6, 'class' => 'color-picker bca-input-color')) ?><br />
			<small>[テキストリンク]</small> #<?php echo $this->BcForm->input('color_link', array('type' => 'text', 'size' => 6, 'class' => 'color-picker bca-input-color')) ?>　
			<small>[テキストホバー]</small> #<?php echo $this->BcForm->input('color_hover', array('type' => 'text', 'size' => 6, 'class' => 'color-picker bca-input-color')) ?>
		</td>
	</tr>
	<tr>
