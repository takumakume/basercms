...
<p>全体で利用するウィジェットエリアは、「<?php $this->BcBaser->link(__d('baser', 'サイト基本設定'), array('controller'=>'site_configs','action'=>'form')) ?>」で設定できます。また、標準プラグインである、ブログ、メールではそれぞれ別のウィジェットエリアを個別に指定する事もできます。</p>
<ul>
