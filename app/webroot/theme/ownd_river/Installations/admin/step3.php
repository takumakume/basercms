...
<?php endif; ?>
	...
	<div class="submit">
		<?php echo $this->BcForm->button(__d('baser', '戻る'), array('type' => 'button', 'class' => 'btn-gray button', 'id' => 'btnback')) ?>
		<?php echo $this->BcForm->button(__d('baser', '接続テスト'), array('type' => 'button', 'class' => 'btn-orange button', 'id' => 'checkdb')) ?>
		<?php if (!isset($blDBSettingsOK) || !$blDBSettingsOK): ?>
			<?php echo $this->BcForm->button(__d('baser', '次のステップへ'), array('type' => 'button', 'class' => 'btn-red button', 'id' => 'btnnext', 'name' => 'btnnext', 'disabled' => 'disabled')) ?>
		<?php else: ?>
			<?php echo $this->BcForm->button(__d('baser', '次のステップへ'), array('type' => 'button', 'class' => 'btn-red button', 'id' => 'btnnext', 'name' => 'btnnext')) ?>
		<?php endif ?>
	</div>
