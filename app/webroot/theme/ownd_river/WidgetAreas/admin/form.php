...
<span class="submit"><?php echo $this->BcForm->end(array('label' => __d('baser', 'エリア名を保存する'), 'div' => false, 'class' => 'button btn-red bca-btn', 'id' => 'WidgetAreaUpdateTitleSubmit', 'data-bca-btn-type' => 'save')) ?></span>
			...
			<?php endif ?>
						...
						<div class="ui-widget-content sortable widget setting <?php echo $widget[$key]['element'] ?><?php echo $enabled ?>" id="Setting<?php echo $widget[$key]['id'] ?>">
							...
							<div class="content" style="text-align:right">
								...
								<?php echo $this->BcForm->input($key . '.use_title', array('type' => 'checkbox', 'label' => __d('baser', 'タイトルを表示'), 'class' => 'use_title')) ?>
								<?php echo $this->BcForm->input($key . '.status', array('type' => 'checkbox', 'label' => __d('baser', '利用する'), 'class' => 'status')) ?>
